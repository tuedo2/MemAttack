...
from scoring import get_risk_scores
...
test = torchvision.datasets.CIFAR10(root='./data', train=False, transform=default_transform, download=False)

BASE_DIR = './cifar10_mia_scores'
num_runs = 5
...
def replace_attack(dir_name, replace_dataset, net_type='VGG', resize=(32, 32)):
    for size in sizes:
        ...
        for i in range(num_runs):
            ...
            scores = get_risk_scores(new_dset, test, net_type)
